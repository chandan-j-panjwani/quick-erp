...
<script>
    ...
    ?>
        toastr.error("Failed to update a category", "Failed");
    <?php
        Session::unsetSession(UPDATE_ERROR);
    elseif (Session::hasSession(UPDATE_SUCCESS)) :
    ?>
        toastr.success("Category has been updated successfuly !", "Updated!!")
    <?php
        Session::unsetSession(UPDATE_SUCCESS);
    elseif (Session::hasSession(DELETE_SUCCESS)) :
    ?>
        toastr.success("Category has been deleted successfuly !", "Success")
    <?php
