...
<script src="<?= BASEASSETS; ?>js/pages/customer/manage-customers.js"></script>
<script>
    toastr.options = {
        "closeButton": true,
        "debug": false,
