...
$page_title = "Quick ERP | Edit Suppliers";
...
if(isset($_GET)){
    $id = $_GET['id'];
    $old = $di->get('supplier')->getSupplierByID($id, PDO::FETCH_ASSOC)[0];
    // Util::dd($old);
}
...
<body id="page-top">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="first_name" class="form-control <?= $errors != '' ? ($errors->has('first_name') ? 'error is-invalid' : '') : ''; ?>" id="first_name" placeholder="Enter First Name" value="<?= $old != '' ? $old['first_name'] : ''; ?>" id="supplier_first_name">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="last_name" class="form-control <?= $errors != '' ? ($errors->has('last_name') ? 'error is-invalid' : '') : ''; ?>" id="last_name" placeholder="Enter Last Name" value="<?= $old != '' ? $old['last_name'] : ''; ?>" id="supplier_last_name">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        <label>GST No.</label>
                                                        <input type="text" name="gst_no" class="form-control <?= $errors != '' ? ($errors->has('gst_no') ? 'error is-invalid' : '') : ''; ?>" id="gst_no" placeholder="Enter GST No." value="<?= $old != '' ? $old['gst_no'] : ''; ?>" id="supplier_gst_no">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="email_id" class="form-control <?= $errors != '' ? ($errors->has('email_id') ? 'error is-invalid' : '') : ''; ?>" id="email_id" placeholder="Enter GST No." value="<?= $old != '' ? $old['email_id'] : ''; ?>" id="supplier_email_id">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="phone_no" class="form-control <?= $errors != '' ? ($errors->has('phone_no') ? 'error is-invalid' : '') : ''; ?>" id="phone_no" placeholder="Enter Phone No." value="<?= $old != '' ? $old['phone_no'] : ''; ?>" id="supplier_phone_no">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="company_name" class="form-control <?= $errors != '' ? ($errors->has('company_name') ? 'error is-invalid' : '') : ''; ?>" id="company_name" placeholder="Enter Phone No." value="<?= $old != '' ? $old['company_name'] : ''; ?>" id="supplier_company_name">
                                                        <?php
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 d-flex">
                                                    <div class="align-self-end ml-auto">
                                                        <input type="submit" value="Submit" name="editSupplier" class="btn btn-success">
                                                        <a href="<?= BASEPAGES; ?>manage-suppliers.php" class="btn btn-danger">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
    ...
    <?php require_once __DIR__ . "/../includes/page-level/suppliers/manage-suppliers-scripts.php"; ?>
